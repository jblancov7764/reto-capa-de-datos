...
from django.http.response import FileResponse, Http404, HttpResponse, HttpResponseBadRequest, HttpResponseNotFound, \
...
class LoginView(TemplateView):
    ...
    def post(self, request):
        ...
        return render(request, 'login.html', {'errors': errors, 'username': form.cleaned_data['username'],
...
def get_data_by_user_and_role(request, **params):
    data_result = {}
